...
class Auction:
    ...
    def write(self):
        ...
        if self.body.__contains__('auctions'):
            ...
            bodySize = 20
        numberFont = pygame.font.Font('monopoly.ttf', numberSize)
        bodyFont = pygame.font.Font('monopoly.ttf', bodySize)
        lineSpacing = 4
...
def boardSetup(): # Sets up all the lists of properties and squares
    ...
    squareNames = ['Go', 'Mediterranean Avenue', 'Community Chest', 'Baltic Avenue', 'Income Tax',
                   'Reading Railroad', 'Oriental Avenue', 'Chance', 'Vemont Avenue',
                   'Conneticaut Avenue', 'Jail', 'St. Charles Place', 'Electric Company', 'States Avenue',
                   ...
                   'Pennsylvania Avenue', 'Short Line', 'Chance', 'Park Place', 'Super Tax', 'Boardwalk']
...
def showMenu(): # Draws the side menu
    ...
    turnFont = pygame.font.Font('monopoly.ttf', 45)
    if user.isTurn:
    ...
    moneyFont = pygame.font.Font('monopoly.ttf', 40)
...
buttonsPic = pygame.image.load('images/buttons.png')

endTurnBehind = pygame.image.load('images/endTurnBehind.png')
endTurnFront = pygame.image.load('images/endTurnFront.png')
endTurnUnAv = pygame.image.load('images/endTurnUnAv.png')
etAvailable = False

mortgageFront = pygame.image.load('images/mortgageFront.png')
...
auctionPic = pygame.image.load('images/auction.png')
auctioning = False
...
choosePieceFont = pygame.font.Font('monopoly.ttf', 100)
choosePieceText = choosePieceFont.render("Select Piece:", True, palette.darkVanilla)

while not user.pieceConfirmed:

    screen.fill(palette.axolotl)
    screen.blit(pygame.image.load('images/choosePiece.png'), (0, 0))
    ...
    screen.blit(pygame.image.load('images/piecesForChoosing.png'), (0, 0))
        ...
        if user.normalGameplay:
            ...
            if user.timeMoving == 0:
                ...
                if type(currentSquare) == Property:
                    ...
                    if not currentSquare.paid:
                        if currentSquare.name == 'Jail' and not user.inJail:
            ...
            if Eve.timeMoving == 0:
                ...
                if type(currentSquare) == Property:
                    ...
                    if not currentSquare.paid:
                        ...
                        if currentSquare.name == 'Jail' and not Eve.inJail:
                            if not alert.confirmed:
